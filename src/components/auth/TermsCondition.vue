<template>
   <div>
       ...
       <div class=" uk-section uk-section-muted">
           <div class="uk-container card" >
               <div class="test">
                   <h1 class="uk-heading-small">Muscle Crab Diversities Terms MemeGalleries.com Of Use</h1>
                   <h3 class=" uk-margin-remove-top"><time datetime="2016-04-01T19:00">Last updated June 21, 2018</time></h3>

                   <h2>AGREEMENT TO TERMS</h2>
                   <a class="uk-button uk-button-primary" href="#bottom" uk-scroll>Scroll down</a>
                   <p id="top">
                       These Terms of Use constitute a legally binding agreement made
                       between you, whether personally or on behalf of an entity (“you”)
                       and Termly LLC (“we,” “us” or “our”), concerning your access to and
                       use of the https://termly.io website as well as any other media form,
                   ...
                   <p>
                       ...
                       not expressly granted to you in and to the Site, the Content and the
                       Marks.
                   </p>
                   ...
                   <p>You may be required to register with the Site. You agree to keep your
                   ...
                   <p>
                       ...
                       for purchases made via the Site. Sales tax will be added to the price of
                   ...
                   <a class="uk-button uk-button-primary" href="#center" uk-scroll>Scroll center</a>
                   <h2>OUR FEES</h2>
                   <p>
                       When registering with Termly, you may select to create a free
                       account. No credit card information is needed at this time but your
                       access to our platform’s features will be limited. You can access our
                       pricing on the following page here: <a href="https://memegalleries.com/user/products">memegalleries.com/user/products</a>
                   </p>
                   <p>
                       If you choose to do so, you may select a paid account that fits your
                       needs. We offer a variety of plans, all available on the page above.
                       Users who previously created accounts and have prior plans with us
                       are able to continue using their prior payment plan unless they
                       upgrade or downgrade their accounts. Any upgrades will occur
                       immediately at a prorated rate. Any downgrades to a user’s account
                       will take place following the end of their current payment term.
                   </p>
                   <h2>CANCELLATION</h2>
                   <p>You can cancel your subscription at any time by logging into your
                       account or contacting us using the contact information provided below.
                       Your cancellation will take effect at the end of the current payment
                       term. All website and policy info will be deleted upon the end of the
                       subscription.</p>

                   <p >If you are unsatisfied with our services, please email us
                       at <a href="https://Sandra.Mitchell@memegalleries.com">Sandra.Mitchell@memegalleries.com</a></p>
                   ...
                   <ol>
                       ...
                       <li>Make any unauthorized use of the Site, including collecting
                       ...
                       <li>Attempt to impersonate another user or person or use the
                           username of another user.</li>
                       <li>Sell or otherwise transfer your profile.</li>
                       <li>Use any information obtained from the Site in order to
                           harass, abuse, or harm another person.</li>
                       <li>Use the Site as part of any effort to compete with us or
                           otherwise use the Site and/or the Content for any revenue-
                           generating endeavor or commercial enterprise.</li>
                       <li>Decipher, decompile, disassemble, or reverse engineer any
                           of the software comprising or in any way making up a part of the
                           Site.</li>
                       <li>Attempt to bypass any measures of the Site designed to
                           prevent or restrict access to the Site, or any portion of the Site.</li>
                       <li>Harass, annoy, intimidate, or threaten any of our
                           employees or agents engaged in providing any portion of the
                           Site to you.</li>
                       <li>Delete the copyright or other proprietary rights notice from
                           any Content.</li>
                       <li>Copy or adapt the Site’s software, including but not limited
                           to Flash, PHP, HTML, JavaScript, or other code.</li>
                       <li>Upload or transmit (or attempt to upload or to transmit)
                       ...
                       <li>Except as may be the result of standard search engine or
                           ...
                           using or launching any unauthorized script or other software.</li>
                       <li>Disparage, tarnish, or otherwise harm, in our opinion, us
                           and/or the Site.</li>
                       <li>Use the Site in a manner inconsistent with any applicable
                ...
                <p>
                    ...
                    that:
                </p><h2>USER GENERATED CONTRIBUTIONS</h2>
                <p>
                    The Site may invite you to chat, contribute to, or participate in blogs,
                    message boards, online forums, and other functionality, and may
                    provide you with the opportunity to create, submit, post, display,
                ...
                <p>
                   ...
                   <ol>
                       <li>You are the creator and owner of or have the necessary
                           ...
                           Terms of Use.</li>
                       <li>You have the written consent, release, and/or permission of each
                       ...
                       <li>Your Contributions are not unsolicited or unauthorized
                           advertising, promotional materials, pyramid schemes, chain
                           letters, spam, mass mailings, or other forms of solicitation.</li>
                       <li>Your Contributions are not obscene, lewd, lascivious, filthy,
                           violent, harassing, libelous, slanderous, or otherwise
                           objectionable (as determined by us).</li>
                       <li>Your Contributions do not ridicule, mock, disparage, intimidate,
                           or abuse anyone.</li>
                       <li>Your Contributions do not advocate the violent overthrow of any
                           government or incite, encourage, or threaten physical harm
                           against another.</li>
                       <li>Your Contributions do not violate any applicable law, regulation,
                           or rule.</li>
                       <li>Your Contributions do not violate the privacy or publicity rights of
                           any third party.</li>
                       <li>Your Contributions do not contain any material that solicits
                           personal information from anyone under the age of 18 or exploits
                           people under the age of 18 in a sexual or violent manner.</li>
                       <li>Your Contributions do not violate any federal or state law
                           concerning child pornography, or otherwise intended to protect
                           the health or well-being of minors;</li>
                       <li>Your Contributions do not include any offensive comments
                           that are connected to race, national origin, gender, sexual
                           preference, or physical handicap.</li>
                       <li>Your Contributions do not otherwise violate, or link to
                           ...
                           suspension of your rights to use the Site.</li>
                   </ol>
                   ...
                   <p>You acknowledge and agree that any questions, comments,
                       ...
                       or misappropriation of any proprietary right in your Submissions.</p>
                   <h2>THIRD-PARTY WEBSITES AND CONTENT</h2>
                   <p>The Site may contain (or you may be sent via the Site) links to other
                       ...
                       Party Websites accessed through the Site or any Third-Party Content
                       ...
                       use or installation of any Third-Party Websites or any Third-
                       Party Content does not imply approval or endorsement thereof by us.
                       If you decide to leave the Site and access the Third-Party Websites or
                       ...
                       on Third-Party Websites and you shall hold us harmless from any
                   ...
                   <p>
                       ...
                       our systems; and (5) otherwise manage the Site in a manner designed
                   ...
                   <p>
                       ...
                       Policy: <a href="https://memegalleries.com/policy">https://memegalleries.com/policy.html???</a> . By using the Site,
                       ...
                       age of 13 has provided personal information to us without the requisite
                   ...
                   <ul>
                       <li>Muscle Crab Diversities</li>
                       <li>Attn: Sandra Mitchell</li>
                       <li>Jamaica</li>
                       <li>Sandra.Mitchell@memegalleries.com</li>
                   </ul>

<h2>TERM AND TERMINATION</h2>
<p>These Terms of Use shall remain in full force and effect while you use
...
<p>
    ...
    written notice from one Party to the other Party.
                   ...
                   <p>
                       ...
                       THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND WE
                       ...
                       ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS
                       TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO
                       ...
                       PARTY THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR
                       ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY
                   ...
                   <p>
                       ...
                       IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD
                       PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN STATE
                       LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES
                       OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF
                   ...
                   <h2>USER DATA</h2>
                   <p>We will maintain certain data that you transmit to the Site for the
                   ...
                   <p>
                       ...
                       Terms of Use.
                   </p><a class="uk-button uk-button-primary" href="#top" uk-scroll>Scroll to top</a>
                   <h2>CONTACT US</h2>
                   <p id="bottom">In order to resolve a complaint regarding the Site or to receive further
                       information regarding use of the Site, please contact us at:</p>
                   <p>Sandra Mitchell</p><span><a href="Sandra.Mitchell@memegalleries.com">Sandra.Mitchell@memegalleries.com</a></span>
               </div>
           </div>
       </div>
   </div>
